    ...
    return (
      <div>
        <Form layout='horizontal' className={styles.formHeight} onSubmit={this.basicHandleSubmit}>
          ...
          <Title title='高级选项' />
          <FormItem label='普通场每日次数' {...this.formLayout}>
            {getFieldDecorator( 'userDayMaxCountNormal', {
              rules: [{
                required: true,
                message: '请输入每日次数'
              }],
              initialValue: data.userDayMaxCountNormal || '',
            } )( <Input
              onChange={this.onChangeUserAttendCount}
              placeholder='设置普通场每日参与次数'
              precision={0}
              min={0}
              max={1000000}
              addonAfter='次'
          ...
          <FormItem label='挑战场每日次数' {...this.formLayout}>
            {getFieldDecorator( 'userDayMaxCountChallenge', {
              rules: [{
                required: true,
                message: `请输入每日次数`
              }],
              initialValue: data.userDayMaxCountChallenge || '',
            } )( <Input
              onChange={this.onChangeUserAttendCount}
              placeholder='设置挑战场每日参与次数'
              precision={0}
              min={0}
              max={1000000}
              addonAfter='次'
