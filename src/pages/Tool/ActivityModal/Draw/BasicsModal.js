    ...
    return (
      <div>
        <Form layout='horizontal' className={styles.formHeight} onSubmit={this.basicHandleSubmit}>
          ...
          <Title title='高级选项' />
          {/* <FormItem label='需登录参与' {...this.formLayout}>
            {getFieldDecorator( 'isNeedLogin', {
              rules: [{ required: true } ],
              initialValue: data.isNeedLogin===undefined ? true : data.isNeedLogin
            } )(
          ...
          <FormItem label='参与次数展示' {...this.formLayout}>
            ...
            <span style={{ fontSize:12, marginLeft:'20px' }}>*若未配置奖品，建议参与次数不展示</span>
          </FormItem>
          <FormItem
            style={{ paddingTop: 20 }}
