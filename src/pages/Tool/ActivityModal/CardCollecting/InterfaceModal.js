...
@connect()
@Form.create()
class InterfaceModal extends PureComponent {
                ...
                >
                  <FormItem>
                    {getFieldDecorator('introductionImg', {
                      rules: [{ required: true, message: '顶部图不能为空！' }],
                ...
                >
                  <FormItem>
                    {getFieldDecorator('backgroundImg', {
                      rules: [{ required: true, message: '背景图不能为空！' }],
                ...
                >
                  <FormItem>
                    {getFieldDecorator('cardImg', {
                      rules: [{ required: true, message: '卡片背景图不能为空！' }],
...
const Reminder = ({ type, msg = '', style = {} }) => {
  ...
  return <div className={styles.collect_reminder} style={style}>{text}</div>
}
