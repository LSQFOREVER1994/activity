...
import { Input, Modal, Form, Table, Select, Icon, message, Spin, Alert } from 'antd';
            ...
            >
              <Spin spinning={loading}>
                <Form className={styles.formHeight} onSubmit={this.handleSubmit}>
                  <FormItem label='选择奖品' {...this.formLayout}>
                  ...
                  <FormItem label='奖项名称' {...this.formLayout}>
                    {getFieldDecorator( 'name', {
                      rules: [{ required: true, message: `${formatMessage( { id: 'form.input' } )}奖项名称` }],
                      initialValue: prizeCurrent.name,
                    } )(
                      <Input placeholder={`${formatMessage( { id: 'form.input' } )}奖项名称`} />
                    )}
                  </FormItem>
