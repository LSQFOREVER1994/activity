...
class Prize extends PureComponent {
  ...
  render() {
    ...
    const columns =[
      ...
      //   align: 'center',
      //   render:daySendMaxCount=><span>{daySendMaxCount !==undefined ? `${daySendMaxCount}个` : '--'}</span>
      // },
      {
        title: <span>已用数量</span>,
        dataIndex: 'sendCount',
        align: 'center',
      ...
      //   align: 'center',
      //   render:surplusCount=><span>{surplusCount !==undefined ? `${surplusCount}个` : '--'}</span>
      // },
      {
