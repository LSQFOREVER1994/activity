...
@connect()
@Form.create()
class TaskSetting extends PureComponent {
...

          {
            ...
            <div>
              ...
              <FormItem label='任务弹窗标题' {...this.formLayout}>
                ...
                } )( <Input placeholder='清输入任务弹窗标题' maxLength={10} onChange={( e ) => this.onChange( e )} /> )}
                <span style={{ position: 'absolute', right: 10, bottom: -10, color: 'rgba(0, 0, 0, 0.25)' }}>{titleValue.length}/10</span>
              </FormItem>

              <div style={{ display: 'flex', padding: '30px 0 50px 15%', alignItems: 'center' }}>
