        ...
        <Row gutter={[8, 8]} style={{ margin: '10px 0' }}>
          <Col span={12} md={6}>
            <StatisticCard 
              ...
              today={appointAppData.newUv ? appointAppData.newUv : ''}
              yestoday={appointAppData.preNewUv ? appointAppData.preNewUv : ''}
          ...
          <Col span={12} md={6}>
            <StatisticCard 
              ...
              today={appointAppData.uv ? appointAppData.uv : ''}
              yestoday={appointAppData.preUv ? appointAppData.preUv : ''}
          ...
          <Col span={12} md={6}>
            <StatisticCard 
              ...
              today={appointAppData.pv ? appointAppData.pv : ''}
              yestoday={appointAppData.prePv ? appointAppData.prePv : ''}
          ...
          {/* <Col span={12} md={6}>
            <StatisticCard 
              ...
              today={appointAppData.ips ? appointAppData.ips : ''}
              yestoday={appointAppData.preIps ? appointAppData.preIps : ''}
