...
import styles from './scratchCardElement.less'
...
@connect()
@Form.create()
class ScratchCardElement extends PureComponent {
  formLayout = {
    labelCol: { span: 4 },
    wrapperCol: { span: 16 },
  };
  ...
  initElmentData = () => {
    ...
    const defaultObj = {
      ...
      paddingRight: 30,
      showLeftCount:true,
      beforeScratch: `${serviceObj.defaultImagePath}GGK_GQ.png`,
      afterScratch: `${serviceObj.defaultImagePath}GGK_GH.png`,
    }
    ...
    return (
      <div>
        <div>
          ...
          <FormItem
            label={<span className={styles.labelText}><span>*</span>活动时间</span>}
            {...this.formLayout}
          >
            <RangePicker
              style={{ width: '100%' }}
          ...
          <FormItem
            label={<span className={styles.labelText}><span>*</span>刮奖区覆盖图</span>}
            {...this.formLayout}
          >
            <div style={{ display: 'flex' }}>
              <UploadModal value={eleObj.beforeScratch} onChange={( e ) => this.changeValue( e, 'beforeScratch' )} />
              <div
                style={
                  {
                    width: '180px',
          ...
          <FormItem
            label={<span className={styles.labelText}><span>*</span>刮奖后背景图</span>}
            {...this.formLayout}
          >
            <div style={{ display: 'flex' }}>
              <UploadModal value={eleObj.afterScratch} onChange={( e ) => this.changeValue( e, 'afterScratch' )} />
              <div
                style={
                  {
                    width: '180px',
...
export default ScratchCardElement;
